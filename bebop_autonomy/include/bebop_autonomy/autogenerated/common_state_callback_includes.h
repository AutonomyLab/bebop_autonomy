...
common_commonstate_allstateschanged_ptr.reset(new cb::CommonCommonStateAllStatesChanged(nh, priv_nh, "states/common/CommonState/AllStatesChanged"));
common_commonstate_batterystatechanged_ptr.reset(new cb::CommonCommonStateBatteryStateChanged(nh, priv_nh, "states/common/CommonState/BatteryStateChanged"));
common_commonstate_massstoragestatelistchanged_ptr.reset(new cb::CommonCommonStateMassStorageStateListChanged(nh, priv_nh, "states/common/CommonState/MassStorageStateListChanged"));
common_commonstate_massstorageinfostatelistchanged_ptr.reset(new cb::CommonCommonStateMassStorageInfoStateListChanged(nh, priv_nh, "states/common/CommonState/MassStorageInfoStateListChanged"));
common_commonstate_currentdatechanged_ptr.reset(new cb::CommonCommonStateCurrentDateChanged(nh, priv_nh, "states/common/CommonState/CurrentDateChanged"));
common_commonstate_currenttimechanged_ptr.reset(new cb::CommonCommonStateCurrentTimeChanged(nh, priv_nh, "states/common/CommonState/CurrentTimeChanged"));
common_commonstate_massstorageinforemaininglistchanged_ptr.reset(new cb::CommonCommonStateMassStorageInfoRemainingListChanged(nh, priv_nh, "states/common/CommonState/MassStorageInfoRemainingListChanged"));
common_commonstate_wifisignalchanged_ptr.reset(new cb::CommonCommonStateWifiSignalChanged(nh, priv_nh, "states/common/CommonState/WifiSignalChanged"));
common_commonstate_sensorsstateslistchanged_ptr.reset(new cb::CommonCommonStateSensorsStatesListChanged(nh, priv_nh, "states/common/CommonState/SensorsStatesListChanged"));
common_commonstate_productmodel_ptr.reset(new cb::CommonCommonStateProductModel(nh, priv_nh, "states/common/CommonState/ProductModel"));
common_commonstate_countrylistknown_ptr.reset(new cb::CommonCommonStateCountryListKnown(nh, priv_nh, "states/common/CommonState/CountryListKnown"));
common_overheatstate_overheatchanged_ptr.reset(new cb::CommonOverHeatStateOverHeatChanged(nh, priv_nh, "states/common/OverHeatState/OverHeatChanged"));
common_overheatstate_overheatregulationchanged_ptr.reset(new cb::CommonOverHeatStateOverHeatRegulationChanged(nh, priv_nh, "states/common/OverHeatState/OverHeatRegulationChanged"));
common_controllerstate_ispilotingchanged_ptr.reset(new cb::CommonControllerStateisPilotingChanged(nh, priv_nh, "states/common/ControllerState/isPilotingChanged"));
common_mavlinkstate_mavlinkfileplayingstatechanged_ptr.reset(new cb::CommonMavlinkStateMavlinkFilePlayingStateChanged(nh, priv_nh, "states/common/MavlinkState/MavlinkFilePlayingStateChanged"));
common_mavlinkstate_mavlinkplayerrorstatechanged_ptr.reset(new cb::CommonMavlinkStateMavlinkPlayErrorStateChanged(nh, priv_nh, "states/common/MavlinkState/MavlinkPlayErrorStateChanged"));
common_calibrationstate_magnetocalibrationstatechanged_ptr.reset(new cb::CommonCalibrationStateMagnetoCalibrationStateChanged(nh, priv_nh, "states/common/CalibrationState/MagnetoCalibrationStateChanged"));
common_calibrationstate_magnetocalibrationrequiredstate_ptr.reset(new cb::CommonCalibrationStateMagnetoCalibrationRequiredState(nh, priv_nh, "states/common/CalibrationState/MagnetoCalibrationRequiredState"));
common_calibrationstate_magnetocalibrationaxistocalibratechanged_ptr.reset(new cb::CommonCalibrationStateMagnetoCalibrationAxisToCalibrateChanged(nh, priv_nh, "states/common/CalibrationState/MagnetoCalibrationAxisToCalibrateChanged"));
common_calibrationstate_magnetocalibrationstartedchanged_ptr.reset(new cb::CommonCalibrationStateMagnetoCalibrationStartedChanged(nh, priv_nh, "states/common/CalibrationState/MagnetoCalibrationStartedChanged"));
common_flightplanstate_availabilitystatechanged_ptr.reset(new cb::CommonFlightPlanStateAvailabilityStateChanged(nh, priv_nh, "states/common/FlightPlanState/AvailabilityStateChanged"));
common_flightplanstate_componentstatelistchanged_ptr.reset(new cb::CommonFlightPlanStateComponentStateListChanged(nh, priv_nh, "states/common/FlightPlanState/ComponentStateListChanged"));
common_arlibsversionsstate_controllerlibarcommandsversion_ptr.reset(new cb::CommonARLibsVersionsStateControllerLibARCommandsVersion(nh, priv_nh, "states/common/ARLibsVersionsState/ControllerLibARCommandsVersion"));
common_arlibsversionsstate_skycontrollerlibarcommandsversion_ptr.reset(new cb::CommonARLibsVersionsStateSkyControllerLibARCommandsVersion(nh, priv_nh, "states/common/ARLibsVersionsState/SkyControllerLibARCommandsVersion"));
common_arlibsversionsstate_devicelibarcommandsversion_ptr.reset(new cb::CommonARLibsVersionsStateDeviceLibARCommandsVersion(nh, priv_nh, "states/common/ARLibsVersionsState/DeviceLibARCommandsVersion"));
common_audiostate_audiostreamingrunning_ptr.reset(new cb::CommonAudioStateAudioStreamingRunning(nh, priv_nh, "states/common/AudioState/AudioStreamingRunning"));
common_headlightsstate_intensitychanged_ptr.reset(new cb::CommonHeadlightsStateintensityChanged(nh, priv_nh, "states/common/HeadlightsState/intensityChanged"));
common_animationsstate_list_ptr.reset(new cb::CommonAnimationsStateList(nh, priv_nh, "states/common/AnimationsState/List"));
common_accessorystate_supportedaccessorieslistchanged_ptr.reset(new cb::CommonAccessoryStateSupportedAccessoriesListChanged(nh, priv_nh, "states/common/AccessoryState/SupportedAccessoriesListChanged"));
common_accessorystate_accessoryconfigchanged_ptr.reset(new cb::CommonAccessoryStateAccessoryConfigChanged(nh, priv_nh, "states/common/AccessoryState/AccessoryConfigChanged"));
common_accessorystate_accessoryconfigmodificationenabled_ptr.reset(new cb::CommonAccessoryStateAccessoryConfigModificationEnabled(nh, priv_nh, "states/common/AccessoryState/AccessoryConfigModificationEnabled"));
common_chargerstate_maxchargeratechanged_ptr.reset(new cb::CommonChargerStateMaxChargeRateChanged(nh, priv_nh, "states/common/ChargerState/MaxChargeRateChanged"));
common_chargerstate_currentchargestatechanged_ptr.reset(new cb::CommonChargerStateCurrentChargeStateChanged(nh, priv_nh, "states/common/ChargerState/CurrentChargeStateChanged"));
common_chargerstate_lastchargeratechanged_ptr.reset(new cb::CommonChargerStateLastChargeRateChanged(nh, priv_nh, "states/common/ChargerState/LastChargeRateChanged"));
common_chargerstate_charginginfo_ptr.reset(new cb::CommonChargerStateChargingInfo(nh, priv_nh, "states/common/ChargerState/ChargingInfo"));
